...
<div class="content-container">
    <section id="about" class="text-section">
        <h2>About THPT the RFOF EXtention eXtended Spider.WEB</h2>
        <p>We strive to enhance The EuroChain.dex and foster the growth of games and capital, enabling THPT(Shadow Of MetropoliZ) to draw energy from all other decentralized Chains or Networks. Our aim is to win the QCH-L-C(Quantum Core Hackers Leagu Club) Blockchain Contest, with missions focused on Bridging our RFOF NETWORK to serve as an extension of the RFOF BOxChain. Let's grow!</p>
    </section>
